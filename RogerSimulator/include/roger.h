...
#define L_EYE          0.07/* [m] - the length of an eye link*/
...
// toybox object geometry
#define R_TOYS         0.25
#define CIRCLE         0
#define TRIANGLE       1 
#define SQUARE         2
#define TRIANGLE_RECEP 3
#define SQUARE_RECEP   4

#define M_TOY        0.5   /* [kg] */
#define I_TOY        0.02  /* [kg m^2] */
#define R_TOY        0.25  /* [m] - the radius of the red ball */
...
// Number of intertial objects that can collide in the Cartesian plane
// and are specific to each robot (Base, Arm1, Arm2)
#define N_BODY_ROBOT    3

// Number of visible objects that are specific to each robot (Arm1, Arm2)
#define N_VISIBLEOBJ_ROBOT  2
...
#define R_PUPIL        0.045  /* [m] - the radius of a pupil */
...
#define EYE_W0 			122.21
#define ELBOW_W0		50.30
#define SHOULDER_W0     30.01
