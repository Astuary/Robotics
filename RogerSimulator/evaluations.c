...
PongEval* pong_evaluator;
{
  if (pong_evaluator->goal_1 == MAX_SCORE || 
    ...
    if (pong_evaluator->goal_1 == MAX_SCORE) printf("Roger 1 WINS\n");
    if (pong_evaluator->goal_2 == MAX_SCORE) printf("Roger 2 WINS\n");
    return 1;
  }
  return 0;
}
...
int pong_fault_detection(min_x, max_x, min_y, max_y, middle, 
                         ...
                         arm1_pos_x, arm1_pos_y, arm2_pos_x,
			 arm2_pos_y, hand_radius, roger_id, pong_evaluator) 
